...
local keys = {
   -- misc/useful --
   { key = 'v', mods = mod.SUPER_REV, action = 'ActivateCopyMode' },
   { key = 'p', mods = mod.SUPER, action = act.ActivateCommandPalette },
   { key = 'o', mods = mod.SUPER_REV, action = act.ShowLauncher },
   { key = 'i', mods = mod.SUPER_REV, action = act.ShowLauncherArgs({ flags = 'FUZZY|TABS' }) },
   {
      key = 'u',
      mods = mod.SUPER_REV,
